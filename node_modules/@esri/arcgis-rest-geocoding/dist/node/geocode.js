...
function geocode(address) {
    ...
    if (typeof address === "string") {
        ...
        endpoint = helpers_1.ARCGIS_ONLINE_GEOCODING_URL;
    }
    else {
        endpoint = address.endpoint || helpers_1.ARCGIS_ONLINE_GEOCODING_URL;
        options = arcgis_rest_request_1.appendCustomParams(address, [
            ...
            "outFields",
            "magicKey"
        ], { params: tslib_1.__assign({}, address.params) });
    }
    // add spatialReference property to individual matches
    return arcgis_rest_request_1.request(arcgis_rest_request_1.cleanUrl(endpoint) + "/findAddressCandidates", options).then(function (response) {
