...
function bulkGeocode(requestOptions // must POST, which is the default
    ...
    if (!requestOptions.authentication &&
        options.endpoint === helpers_1.ARCGIS_ONLINE_GEOCODING_URL) {
        return Promise.reject("bulk geocoding using the ArcGIS service requires authentication");
    }
    return arcgis_rest_request_1.request(arcgis_rest_request_1.cleanUrl(options.endpoint) + "/geocodeAddresses", options).then(function (response) {
